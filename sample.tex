...
% data sets
\newcommand{\data setTwosampleY}{\mathcal{Y}_{\sampleSize_1}}
\newcommand{\data setTwosampleZ}{\mathcal{Z}_{\sampleSize_2}}
\newcommand{\data setIndep}{\mathcal{X}_{n}}
%algorithm names
