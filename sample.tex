...
%\paragraph{Setting for multinomial testing.}
...
%\paragraph{Setting for density testing.}
...
\begin{appendix}
	...
	\begin{definition}[Generalized randomized response mechanism for multinomial data: \texttt{GenRR}] \label{def:GenRR_formal}
